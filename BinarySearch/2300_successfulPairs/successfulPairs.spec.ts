...
import { successfulPairs, successfulPairs1, successfulPairs2 } from "./successfulPairs"
...
describe("successfulPairs2", () => {
    it("1", () => {
        expect(successfulPairs2([5, 1, 3], [1, 2, 3, 4, 5], 7).toString()).toBe([4, 0, 3].toString())
    })
    it("2", () => {
        expect(successfulPairs2(spells, potions, 5433930978).toString()).toBe(result.toString())
    })
})
